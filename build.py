...
# 2. the wrapper is formatted correctly for removal by the IITC-ja Mobile android app
pluginWrapperStart = """
...
# load main.js, parse, and create main total-conversion-build-ja.user.js
main = readfile('main.js')

downloadUrl = distUrlBase and distUrlBase + '/total-conversion-build-ja.user.js' or 'none'
updateUrl = distUrlBase and distUrlBase + '/total-conversion-build-ja.meta.js' or 'none'
main = doReplacements(main,downloadUrl=downloadUrl,updateUrl=updateUrl)

saveScriptAndMeta(main, outDir, 'total-conversion-build-ja.user.js', oldDir)
...
if buildMobile:
    ...
    try:
        ...
        pass
    shutil.copy(os.path.join(outDir,"total-conversion-build-ja.user.js"), "mobile/assets/total-conversion-build-ja.user.js")
    ...
    if buildMobile != 'copyonly':
        ...
        if retcode != 0:
            ...
            shutil.copy("mobile/bin/IITC-ja_Mobile-%s.apk" % buildMobile, os.path.join(outDir,"IITC-ja_Mobile-%s.apk" % buildMobile) )
