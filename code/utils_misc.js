...
// TODO 最新版IITCでこのifは無いのだが無いとIITCについてが開かないorz
  ...
  var a = '' +
    '  <div><b>IITCについて</b></div> ' +
    '  <div>Ingress Intel Total Conversion</div> ' +
    '  <hr>' +
    '  <div>' +
    '   <a href="http://ingress.love/iitc-ja/" target="_blank">IITC日本語化ホームページ</a><br />' +
    '    日本語化ホームページでは以下のことができます:' +
    '    <ul>' +
    '      <li>アップデートを探す</li>' +
    '      <li>日本語化・最適化されたプラグインを探す</li>' +
    '      <li>本家版ソースコードとの差分を確認する</li>' +
    '    </ul>' +
    '  </div>' +
    '  <div>' +
    '    <a href="http://iitc.me/" target="_blank">本家IITCホームページ</a><br />' +
    '     本家ホームページでは以下のことができます:' +
    '     <ul>' +
    '       <li>アップデートを探す</li>' +
    '       <li>プラグインを取得する</li>' +
    '       <li>バグを報告する(日本語化版のバグはこちらに報告しないで下さい)</li>' +
    '       <li>寄付する</li>' +
    '     </ul>' +
    '  </div>' +
    '  <div>' +
