// ==UserScript==
// @id             ingress-intel-total-conversion-ja
// @name           IITC-ja: Ingress intel map total conversion
// @version        0.26.0.@@DATETIMEVERSION@@
// @namespace      https://github.com/ShinkoLab/ingress-intel-total-conversion-ja
// @updateURL      @@UPDATEURL@@
...
document.body.innerHTML = '' +
  ...
  '</tr></table></form>' +
  '<a id="sidebartoggle" accesskey="i" title="サイドバー表示切替 [i]"><span class="toggle close"></span></a>' +
  '<div id="scrollwrapper">' + // enable scrolling for small screens
  '  <div id="sidebar" style="display: none">' +
  '    <div id="playerstat">t</div>' +
  '    <div id="gamestat">&nbsp;グローバルコントロールステータスを読み込み中</div>' +
  ...
  '    <input id="redeem" placeholder="パスコード" type="text"/>' +
  '    <div id="toolbox">' +
