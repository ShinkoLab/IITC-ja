// ==UserScript==
// @id             iitc-plugin-score-cycle-times@IITC-ja
// @name           IITC-ja plugin: Show scoreboard cycle/checkpoint times
...
window.plugin.scoreCycleTimes.update = function() {
  ...
  var html = '<table>' +
           formatRow('サイクル開始', cycleStart) +
           formatRow('チェックポイント開始', checkpointStart) +
           formatRow('チェックポイント終了', checkpointEnd) +
           formatRow('サイクル終了', cycleEnd) +
           '</table>';
